...
namespace r5_160
{
	...
	// GpuBone_t from vertex shader? see hwData flag 'VERT_TEXCOORD3'
	/*
	struct GpuBone_t
	{
		int params;                    // Offset:    0
		float3 pos;                    // Offset:    4
		float4 rot;                    // Offset:   16
	};
	*/
	struct UnkDataType_0_t
	{
		char unk_0[4];

		// position and rotation, of what? (bone if head comment is correct)
		Vector pos;
		Quaternion quat;
	};

	struct UnkDataType_1_t
	{
		float unk_0[7];
		int unk_1C;
	};
	...
	struct mstudiohitboxset_t
	{
		...
		const mstudiobbox_t* const pHitbox(const uint16_t i) const { return reinterpret_cast<const mstudiobbox_t* const>((char*)this + FIX_OFFSET(hitboxindex)) + i; }
	};
	...
	struct mstudioikchain_t
	{
		...
		uint16_t numlinks;
		uint16_t linkindex;
		inline const mstudioiklink_t* const pLink(const uint16_t i) const { return reinterpret_cast<const mstudioiklink_t* const>((const char*)this + FIX_OFFSET(linkindex)) + i; }
	...
	static_assert(sizeof(mstudiocompressedikerror_t) == 0x1A);
	...
	struct mstudioikrule_t
	{
		...
		inline r5::mstudioanimvalue_t* pAnimvalue(const int i, const uint16_t* section) const { return (section[i] > 0) ? reinterpret_cast<r5::mstudioanimvalue_t*>((char*)section + section[i]) : nullptr; }
	...
	static_assert(sizeof(mstudioikrule_t) == 0x70);
	...
	struct mstudioanimdesc_t
	{
		...
		inline const r5::mstudioframemovement_t* const pFrameMovement() const { return reinterpret_cast<const r5::mstudioframemovement_t* const>((char*)this + FIX_OFFSET(framemovementindex)); }
		...
		inline const mstudioikrule_t* const pIKRule(const uint16_t i) const;
		...
		inline const mstudioanimsections_t* const pSection(const int i) const { return reinterpret_cast<const mstudioanimsections_t* const>((char*)this + FIX_OFFSET(sectionindex)) + i; }
	...
	struct mstudioseqdesc_t
	{
		...
		uint16_t numevents;
		uint16_t eventindex;
		inline const mstudioevent_t* const pEvent(const int i) const { return reinterpret_cast<mstudioevent_t*>((char*)this + FIX_OFFSET(eventindex)) + i; }
		...
		//const mstudioanimdesc_t* const pAnimDesc(const uint16_t i) const { return reinterpret_cast<const mstudioanimdesc_t* const>((char*)this + AnimIndex(i)); }
		...
		inline const r5::mstudioautolayer_t* const pAutoLayer(const int i) const { return reinterpret_cast<const r5::mstudioautolayer_t* const>((char*)this + FIX_OFFSET(autolayerindex)) + i; }
		...
		inline const mstudioiklock_t* const pIKLock(const int i) const { return reinterpret_cast<const mstudioiklock_t* const>((char*)this + FIX_OFFSET(iklockindex)) + i; }
		...
		inline const mstudioactivitymodifier_t* const pActivityModifier(const int i) const { return reinterpret_cast<mstudioactivitymodifier_t*>((char*)this + FIX_OFFSET(activitymodifierindex)) + i; }
	...
	struct mstudiomodel_t
	{
		...
		uint16_t meshOffset;
		inline mstudiomesh_t* const pMesh(const uint16_t meshIdx) const { return reinterpret_cast<mstudiomesh_t*>((char*)this + FIX_OFFSET(meshOffset)) + meshIdx; }
	};
	...
	struct mstudiobodyparts_t
	{
		...
		uint16_t modelindex;
		inline mstudiomodel_t* const pModel(const uint16_t i) const { return reinterpret_cast<mstudiomodel_t*>((char*)this + FIX_OFFSET(modelindex)) + i; }
	...
	struct studiohdr_t
	{
		...
		inline const mstudiobodyparts_t* const pBodypart(const uint16_t i) const { assert(i >= 0 && i < numbodyparts); return reinterpret_cast<mstudiobodyparts_t*>((char*)this + FIX_OFFSET(bodypartindex)) + i; }
		...
		inline const uint8_t* pBoneStates() const { return boneStateCount > 0 ? reinterpret_cast<uint8_t*>((char*)this + offsetof(studiohdr_t, boneStateOffset) + FIX_OFFSET(boneStateOffset)) : nullptr; }

		// sets of lods
		uint16_t groupHeaderOffset;
		uint16_t groupHeaderCount;
		const studio_hw_groupdata_t* const pLODGroup(const uint16_t i) const { return reinterpret_cast<const studio_hw_groupdata_t* const>((char*)this + offsetof(studiohdr_t, groupHeaderOffset) + FIX_OFFSET(groupHeaderOffset)) + i; }

		uint16_t lodOffset;
		uint16_t lodCount;
		const float* const pLODThreshold(const uint16_t i) const { return reinterpret_cast<const float* const>((char*)this + offsetof(studiohdr_t, lodOffset) + FIX_OFFSET(lodOffset)) + i; }
...
namespace r5_170
{
	...
	struct studiohdr_t
	{
		...
		uint16_t numbodyparts;
		uint16_t bodypartindex;
		inline const r5_160::mstudiobodyparts_t* const pBodypart(const uint16_t i) const { assert(i >= 0 && i < numbodyparts); return reinterpret_cast<const r5_160::mstudiobodyparts_t* const>((char*)this + FIX_OFFSET(bodypartindex)) + i; }
		...
		uint16_t groupHeaderOffset;
		uint16_t groupHeaderCount;
		const r5_160::studio_hw_groupdata_t* const pLODGroup(const uint16_t i) const { return reinterpret_cast<const r5_160::studio_hw_groupdata_t* const>((char*)this + offsetof(studiohdr_t, groupHeaderOffset) + FIX_OFFSET(groupHeaderOffset)) + i; }
...
namespace r5_180
{
	...
	struct mstudioseqdesc_t
	{
		...
		uint16_t numevents;
		uint16_t eventindex;
		inline const r5_160::mstudioevent_t* const pEvent(const int i) const { return reinterpret_cast<r5_160::mstudioevent_t*>((char*)this + FIX_OFFSET(eventindex)) + i; }
		...
		uint16_t numiklocks;
		uint16_t iklockindex;
		inline const r5_160::mstudioiklock_t* const pIKLock(const int i) const { return reinterpret_cast<const r5_160::mstudioiklock_t* const>((char*)this + FIX_OFFSET(iklockindex)) + i; }
		...
		uint16_t activitymodifierindex;
		uint16_t numactivitymodifiers;
		inline const r5_160::mstudioactivitymodifier_t* const pActivityModifier(const int i) const { return reinterpret_cast<r5_160::mstudioactivitymodifier_t*>((char*)this + FIX_OFFSET(activitymodifierindex)) + i; }
...
namespace r5_191
{
	struct mstudioanimdesc_t
	{
		...
		uint16_t ikruleindex; // non-zero when IK data is stored in the mdl
		inline const r5_160::mstudioikrule_t* const pIKRule(const uint16_t i) const;

		AssetGuid_t animDataAsset; // guid in pak, should be pointer to asset on load. not set if STUDIO_HAS_ANIM is missing
		...
		uint16_t sectionstallframes; // number of stall frames inside the animation, the reset excluding the final frame are stored externally. when external data is not loaded(?)/found(?) it falls back on the last frame of this as a stall
		uint16_t sectionframes; // number of frames used in each fast lookup section, zero if not used
		inline const r5_160::mstudioanimsections_t* const pSection(const uint16_t i) const { return reinterpret_cast<const r5_160::mstudioanimsections_t* const>((char*)this + FIX_OFFSET(sectionindex)) + i; }
		// numsections = ((numframes - sectionstallframes - 1) / sectionframes) + 2;
		// numsections after stall section, if stall frames > zero add one section
	};
}
...
namespace r5
{
	...
	inline const float* const pWeightList_Static(const void* const baseptr, const uint16_t weightlistindex)
	{
		...
		default:
		{
			return reinterpret_cast<float*>((char*)baseptr + FIX_OFFSET(weightlistindex));
		}
		}
	}

	// move these to r5_160 if ikrule struct changes
	static const r5_160::mstudioikrule_t s_StudioIKRule_3[1]{
		{
			.chain = 0,
			.bone = 0,
			.type = 4,
			...
			.compressedikerror {},
			.compressedikerrorindex = sizeof(r5_160::mstudioikrule_t),
	...
	static const r5_160::mstudioikrule_t s_StudioIKRule_5[2]{
		{
			.chain = 0,
			.bone = 0,
			.type = 4,
			...
			.compressedikerror {},
			.compressedikerrorindex = sizeof(r5_160::mstudioikrule_t) * 2,
	...
	inline const r5_160::mstudioikrule_t* const pIKRule_Static(const void* const baseptr, const uint16_t ikruleindex, const uint16_t i)
	{
		switch (ikruleindex)
		{
		case 3:
		...
		default:
		{
			return reinterpret_cast<r5_160::mstudioikrule_t*>((char*)baseptr + FIX_OFFSET(ikruleindex)) + i;
		}
		}
	}
}
...
inline const float* const r5_180::mstudioseqdesc_t::pWeightList() const
{
	return r5::pWeightList_Static(this, weightlistindex);
}

inline const r5_160::mstudioikrule_t* const r5_160::mstudioanimdesc_t::pIKRule(const uint16_t i) const
{
	return r5::pIKRule_Static(this, ikruleindex, i);
}

inline const r5_160::mstudioikrule_t* const r5_191::mstudioanimdesc_t::pIKRule(const uint16_t i) const
{
	return r5::pIKRule_Static(this, ikruleindex, i);
}
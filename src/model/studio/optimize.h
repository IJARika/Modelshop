...
#define MAX_NUM_BONES_PER_STRIP 512 // p2: 53, r1 & r2: 160, r5: 256
...
namespace OptimizedModel
{
	...
	struct MaterialReplacementListHeader_t
	{
		...
		const MaterialReplacementHeader_t* const pMaterialReplacement(int i) const
		{
			return reinterpret_cast<const MaterialReplacementHeader_t* const>((char*)this + replacementOffset) + i;
		}
	};
	...
	struct FileHeader_t
	{
		...
		inline const MaterialReplacementListHeader_t* const pMaterialReplacementList(int lodID) const
		{
			return reinterpret_cast<const MaterialReplacementListHeader_t* const>((char*)this + materialReplacementListOffset) + lodID;
		}

...
Vector GenerateNormal(const Vector& posA, const Vector& posB, const Vector& posC, const bool normalize)
{
	Vector normal(0.0f);
	const Vector val0 = posA - posB;
	const Vector val1 = posC - posB;

	CrossProduct(val0, val1, normal);

...
struct matrix3x4_t
{
	...
	{
		memcpy_s(m_flMatVal, sizeof(m_flMatVal), matrix.Base(), sizeof(matrix.m_flMatVal));
	}
...
// https://github.com/ValveSoftware/source-sdk-2013/blob/master/src/mathlib/mathlib/mathlib.h#L857
inline void MatrixPosition(const matrix3x4_t& matrix, Vector& position)
{
	MatrixGetColumn(matrix, 3, position);
}

// https://github.com/ValveSoftware/source-sdk-2013/blob/master/src/mathlib/mathlib/mathlib.h#L872
...
// https://github.com/ValveSoftware/source-sdk-2013/blob/master/src/mathlib/mathlib/mathlib.h#L547

...
constexpr size_t managedBufferSize = (1024 * 1024 * 32);
static uint32_t managedBufferCount = 8; // adjust this to adjust number of buffers
...
{
public:
	CBufferManager() : bufferCount(managedBufferCount)
	{
